...
async function saveAction(formData: FormData) {
  "use server";
  await createOrUpdateAdminItem("customer", {
...
export default async function Page() {
  const items = await listAdminItems("customer");

  return (
    <AdminShell title="Customers" description="Add, update and delete customer records for MVP operations.">
