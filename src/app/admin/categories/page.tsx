...
async function saveAction(formData: FormData) {
  "use server";
  await createOrUpdateAdminItem("category", {
...
export default async function Page() {
  const items = await listAdminItems("category");

  return (
    <AdminShell title="Categories" description="Add, update and delete Silver, Gold, Premium and future categories.">
