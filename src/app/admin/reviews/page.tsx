...
async function saveAction(formData: FormData) {
  "use server";
  await createOrUpdateAdminItem("review", {
...
export default async function Page() {
  const items = await listAdminItems("review");

  return (
    <AdminShell title="Reviews" description="Add, update and delete customer review records.">
