...
async function saveAction(formData: FormData) {
  "use server";
  await createOrUpdateAdminItem("seo", {
...
export default async function Page() {
  const items = await listAdminItems("seo");

  return (
    <AdminShell title="SEO Manager" description="Add, update and delete SEO page metadata records.">
