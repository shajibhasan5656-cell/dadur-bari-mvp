...
async function saveAction(formData: FormData) {
  "use server";
  await createOrUpdateAdminItem("media", {
...
export default async function Page() {
  const items = await listAdminItems("media");

  return (
    <AdminShell title="Media Library" description="Add, update and delete media/image URL records.">
