...
async function saveAction(formData: FormData) {
  "use server";
  await createOrUpdateAdminItem("collection", {
...
export default async function Page() {
  const items = await listAdminItems("collection");

  return (
    <AdminShell title="Collections" description="Add, update and delete Oversized, Anime, Minimal and future collections.">
