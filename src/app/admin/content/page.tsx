...
async function saveAction(formData: FormData) {
  "use server";
  await createOrUpdateAdminItem("content", {
...
export default async function Page() {
  const items = await listAdminItems("content");

  return (
    <AdminShell title="Website Content" description="Add, update and delete website content blocks.">
